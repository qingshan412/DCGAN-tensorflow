...
if {[lindex $argv 0] == "1"} {
	...
	spawn scp model_5.py jliu16@crcfeib01.crc.nd.edu:~/Private/Research/2017/DCGAN/DCGAN-tensorflow/
	...
	spawn scp data/pre_noise/test_ibm.py jliu16@crcfeib01.crc.nd.edu:~/Private/Research/2017/DCGAN/DCGAN-tensorflow/data/pre_noise/test_ibm.py
        ...
        spawn scp main_5.py jliu16@crcfeib01.crc.nd.edu:~/Private/Research/2017/DCGAN/DCGAN-tensorflow/
