  ...
  def discriminator(self, image, y=None, reuse=False):
    with tf.variable_scope("discriminator") as scope:
      ...
      if not self.y_dim:
        ...
        h4 = linear(tf.reshape(h2, [self.batch_size, -1]), 1, 'd_h2_lin')
    ...
    with tf.variable_scope("generator") as scope:
      if not self.y_dim:
        ...
        self.z_, self.h0_w, self.h0_b = linear(
            z, self.gf_dim*8*s_h8*s_w8, 'g_h0_lin', with_w=True)
            #z, self.gf_dim*8*s_h16*s_w16, 'g_h0_lin', with_w=True)

        self.h0 = tf.reshape(
            self.z_, [-1, s_h8, s_w8, self.gf_dim * 8])
            #self.z_, [-1, s_h16, s_w16, self.gf_dim * 8])
        h0 = tf.nn.relu(self.g_bn0(self.h0))

        self.h1, self.h1_w, self.h1_b = deconv2d(
            h0, [self.batch_size, s_h4, s_w4, self.gf_dim*4], name='g_h1', with_w=True)
            #h0, [self.batch_size, s_h8, s_w8, self.gf_dim*4], name='g_h1', with_w=True)
        h1 = tf.nn.relu(self.g_bn1(self.h1))

        h2, self.h2_w, self.h2_b = deconv2d(
            h1, [self.batch_size, s_h2, s_w2, self.gf_dim*2], name='g_h2', with_w=True)
        ...
        h4, self.h4_w, self.h4_b = deconv2d(
            h2, [self.batch_size, s_h, s_w, self.c_dim], name='g_h4', with_w=True)
  ...
  def sampler(self, z, y=None):
    with tf.variable_scope("generator") as scope:
      ...
      if not self.y_dim:
        ...
        # project `z` and reshape
        h0 = tf.reshape(
            linear(z, self.gf_dim*8*s_h8*s_w8, 'g_h0_lin'),
        ...
        h4 = deconv2d(h2, [self.batch_size, s_h, s_w, self.c_dim], name='g_h4')
